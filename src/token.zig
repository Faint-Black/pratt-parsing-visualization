...
pub const Token = struct {
    ...
    pub fn fmtText(self: Token, writer: *std.Io.Writer) !void {
        switch (self.token_type) {
            ...
            .l_curly_bracket => _ = try writer.write("L_CURLY_BRACKET"),
            .r_curly_bracket => _ = try writer.write("R_CURLY_BRACKET"),
    ...
    pub fn fmtSymbol(self: Token, writer: *std.Io.Writer) !void {
        switch (self.token_type) {
            ...
            .l_curly_bracket => try writer.writeByte('{'),
            .r_curly_bracket => try writer.writeByte('}'),
